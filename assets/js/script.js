(function ($) {
  ...
  /*------------------------------------------
    ...
    -------------------------------------------*/
  function map() {
    var locations = [["City inn khulna", 22.820884, 89.551216, 2]];
  ...
  var blankStyleInject =
    '<link href="assets/css/color-style3.css" rel="stylesheet" title="switchstyle">';
  var htmlHead = $("head");
  ...
  function styleSwitcher() {
    if ($(".style-switcher-box").length) {
      ...
      //   targetLink.href = "assets/css/" + "color-style3" + ".css";
      // });
